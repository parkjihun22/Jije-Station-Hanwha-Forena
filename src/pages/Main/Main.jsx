...
const Main = () => {
  ...
  <div className={styles.heroKeyword}>
    경기도 평택시 세교동 725번지 일원
    <br />
    전용 84㎡A · 84㎡B · 84㎡C · 84㎡D · 116㎡A
    <br />
    총 12개 동 · 1,098세대 브랜드 대단지
  </div>

  <p className={styles.heroDesc}>
    5개 노선이 만나는 평택지제역 랜드마크
    <br />
    평택의 주거문화를 바꿀 새로운 중심
    <br />
    한화포레나 지제역
